	...
	: m_world(world), m_position(position), m_region(region)
{
	...
	if (!hasData)
	{
		...
		for (int z = 0; z < Options::chunkSize; z++)
		{
			...
			//Altura at� 5 blocos a baixo do mapa de altura
	...
	//enquanto a chunk n�o estava carregada
...
//Muda o bloco na posi��o(x, y, z) da chunkColumn
...
bool ChunkColumn::BuildMesh()
{
	...
	for (Chunk& chunk : m_chunks)
	{
		...
		{
			chunk.BuildMesh();
			//TODO investigar multithreading para n�o precisar desse break
			//break;
		}
	}
...
//checa para ver se a posicao � valida
